...
theTime.add({
  ...
  update: function (percent) {
    ...
    document.querySelector(".container .sup").innerHTML =
      "Tim tui sắp bay ra ngoài ròiii bà";
  },
});
theTime.add({
  targets: getHeart,
...
document.querySelector(".Description .modal-title").innerHTML =
  '<i class="far fa-comment-alt"></i>&nbsp;Bà biếc vì saoo tim tui nó sắp rớt khônggg:';
document.querySelector(".Description .modal-body").innerHTML =
  'Tò mò chứ rìiii, Rô đọc lá thư điii bà hahaa<i class="fas fa-heart"></i> ';
